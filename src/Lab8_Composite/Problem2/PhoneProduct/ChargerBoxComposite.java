...
public class ChargerBoxComposite extends PhoneSetBoxComposite {
    List<Product> listOfChargers = new ArrayList<>();
    int counter = 0;

    public ChargerBoxComposite(String name, int price) {
        super(name, price);
    }

    @Override
    public void addProduct(Product product){
        this.listOfChargers.add(product);
    }

    @Override
    public void removeProduct(Product product){
        this.listOfChargers.remove(product);
    }
